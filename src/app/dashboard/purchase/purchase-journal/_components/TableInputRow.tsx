...
import { IPurchaseJournalItem } from '../_lib/utils';

interface Props {
    rowNumber: number;
    ratePerUnit: number;
    setRatePerUnits: Dispatch<SetStateAction<number[]>>;
    preqItem: IPurchaseJournalItem;
}
        ...
        <tr>
            ...
            <td className="border border-gray-300 border-l-0">
                <Input
                    field={{
                        ...
                        disabled: true,
                        defaultValue: preqItem?.received_quantity,
                    }}
                />
            </td>
            ...
            <td className="border border-gray-300 border-l-0">
                <input
                    ...
                    type="number"
                    name="total"
                    value={Number(ratePerUnit) * +preqItem.received_quantity}
                    disabled
                    className="border placeholder-gray-400 focus:outline-none focus:border-blue-500  w-full p-2 text-sm border-gray-300 rounded-input-radius text-black autofill:text-black"
                />
            </td>
